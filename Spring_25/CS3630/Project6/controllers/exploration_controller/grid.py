...
class Grid:
    ...
    def __init__(self, fname):
        ...
        with open(fname) as configfile:
            ...
            self.disrupter_init_poses = config['disrupter_init_poses']
            self.disrupter_goals = config['disrupter_goals']
            

            self.occupied = []
            self.occupied_with_disrupters = []
            self.empty = []
            self.markers = []
    ...
    def is_free(self, x, y):
        ...
        yy = int(y) 
        xx = int(x)
        return (xx, yy) not in self.occupied_with_disrupters
    ...
    def is_occupied(self, x, y):
        ...
        yy = int(y)
        xx = int(x)
        return (xx, yy) in self.occupied_with_disrupters
    ...
    def is_collision_with_obstacles(self, p1, p2):
        ...
        for obs in self.occupied_with_disrupters:
